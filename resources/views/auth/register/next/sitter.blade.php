                    ...
                    <div class="loginOptions register-form  register-child">
                        <div id="childContainer">
                            <div id="child_1">
                                ...
                                <textarea required name="experience_description"></textarea>
                                <br>
                                <label class="phone">Age Groups You Have The Most Experience With</label>
                                <div class="cAge" id="sitter-cAge">
                                    <label for="sitterInfant1" id="sitterInfantlabel1">
                                        ...
                                        <input type="checkbox" class="imagetoggle" name="experience_infant" id="sitterInfant1" value="1">
                                    ...
                                    <label for="sitterToddler1" id="sitterToddlerlabel1">
                                        ...
                                        <input type="checkbox" class="imagetoggle" name="experience_toddler" id="sitterToddler1" value="1">
                                    ...
                                    <label for="sitterSchoolAge1" id="sitterSchoolAgelabel1">
                                        ...
                                        <input type="checkbox" class="imagetoggle" name="experience_school_age" id="sitterSchoolAge1" value="1">
