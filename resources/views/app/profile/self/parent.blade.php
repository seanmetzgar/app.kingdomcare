        ...
        <div class="container">
            <div class="left">
                <div class="img-wrapper">
                    <img class="parent-profile" src="images/parentprofile-pic.png" alt="profile picture"/>
                </div>
            ...
            <div id="About"  class="tabcontent active">
                <div class="content-block profile-info aboutbox">
                    ...
                    <div class="right vid">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.78 79.04"><defs></defs><title>playbutton</title><circle class="z" cx="44.17" cy="43.43" r="35.61"/><circle class="b" cx="38.88" cy="38.88" r="37.38"/><polygon class="c" points="26.23 24.97 26.23 53.87 53.48 39.54 26.23 24.97"/></svg>
                ...
                <div class="content-block profile-info babyexp">
                    ...
                    <hr>
                    <p class="babytext">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</p>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    ...
                    <div class="left">
                        ...
                        <p><strong>Hourly Rate: </strong>$12/hr</p>
