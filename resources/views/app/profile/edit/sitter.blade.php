...
@section('search-bar')
    <div class="search sitter-dash sticky">
        <div class="container">
            <h2>My Profile</h2>
            <div class="space"></div>
        </div><!--container-->
                ...
                <div id="PersonalInfo" class="tabcontent" style="display: block;">
                    ...
                    <div class="pinfo full">
                        <div class="profile-infoleft">
                            ...
                            <input type="text" id="video_resume" name="video_reseume" class="inline" value="{{ $profile->video_resume }}">

                            <label for="standard_hourly_rate">Standard Hourly Rate</label>
                            <input type="number" id="standard_hourly_rate" name="standard_hourly_rate" class="inline money" value="{{ $profile->standard_hourly_rate }}">
                        </div>
